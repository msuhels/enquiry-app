  ...
  return (
    <div className="flex flex-col space-y-1 relative">
      ...
      <div className="flex justify-between items-center mb-1">
        <label className="font-medium text-[#3a3886]">
          {label}{" "}
      ...
      {textarea ? (
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            checked={!!value}
            onChange={onChange}
            className="h-5 w-5 cursor-pointer rounded border-2 border-gray-300 focus:ring-1 focus:ring-[#F97316] transition-all disabled:cursor-not-allowed disabled:opacity-50"
